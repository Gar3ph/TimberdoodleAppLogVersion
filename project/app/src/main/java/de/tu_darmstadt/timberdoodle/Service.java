...
public class Service extends android.app.Service implements IService {
    ...
    private final ServiceConnection adtnServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            adtnService = ((de.tu_darmstadt.adtn.Service.LocalBinder) service).getService();
    ...
    public void onCreate() {
        ...
        if (!bindService(new Intent(this, de.tu_darmstadt.adtn.Service.class), adtnServiceConnection, BIND_AUTO_CREATE)) {
