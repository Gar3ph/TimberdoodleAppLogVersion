...
/**
 * Created by Rami Martin, Tobias-Wolfgang Otto
 */
public class AlternateClient implements Runnable {
    ...
    private AlternateBluetoothManager manager;
    ...
    public AlternateClient(BluetoothAdapter bluetoothAdapter, String adressMac, boolean secure, AlternateBluetoothManager manager) {
...
//        uuidCandidates.add(mUuid);
        ...
        try {
            ...
            Log.i("Client", "I connected successfully as a client. Server is: " + mAdressMac + ". I am " + mBluetoothAdapter.getAddress());
